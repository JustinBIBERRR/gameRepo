<template>
  <div class="fixed right-6 bottom-6 z-40">
    ...
    >
      ...
      <!-- 主图标：抽卡/魔术图标（点击用于触摸设备展开/收起） -->
      <button
        type="button"
        class="absolute right-0 bottom-0 w-14 h-14 bg-amber-500 hover:bg-amber-600 text-white rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-110 z-20"
        title="年会抽奖"
        @click.stop="toggleSubIcons"
      >
